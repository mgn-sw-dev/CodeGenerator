...
namespace OptiScan::Core::Config
{
    ...
    public:
        ...
        static inline const std::string FrequencyMax_Hz = "FrequencyMax_Hz";
        ...
        static inline const std::string Latitude = "Latitude";
        ...
        static inline const std::string SystemVersion = "SystemVersion";
